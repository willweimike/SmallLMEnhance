...
llm = Ollama(model="llama3.2:3b", request_timeout=90.0)
...
tools = [
    QueryEngineTool(
        ...
        metadata=ToolMetadata(
            ...
            description="This gives documentation about an API. Use this for reading docs for the API"
        )
    ),
    code_reader
]
...
code_llm = Ollama(model="qwen2.5:7b-instruct-q2_K", request_timeout=90.0)
